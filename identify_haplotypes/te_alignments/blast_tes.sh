...
sort -k1,1 -k12,12nr allhits_TEDB_kindrTE.b6.e10.out | awk '!seen[$1]++' > allhits_TEDB_kindrTE.b6.e10.best.out
sort -k1,1 -k12,12nr allhits_TEDB_kindrTE.b6.e20.out | awk '!seen[$1]++' > allhits_TEDB_kindrTE.b6.e20.best.out
## also the tophit ones
sort -k1,1 -k12,12nr tophit_TEDB_kindrTE.b6.e10.out | awk '!seen[$1]++' > tophit_TEDB_kindrTE.b6.e10.best.out
sort -k1,1 -k12,12nr tophit_TEDB_kindrTE.b6.e20.out | awk '!seen[$1]++' > tophit_TEDB_kindrTE.b6.e20.best.out
