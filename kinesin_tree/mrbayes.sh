...
### nucleotide model only
mpirun ~/software/mrbayes_3.2.2/src/mb-mpi kinesin_homologs_TranslatorX_Prank_align.100m.nuc.nex > kinesin_homologs_TranslatorX_Prank_align.100m.mpi.nex.log 
